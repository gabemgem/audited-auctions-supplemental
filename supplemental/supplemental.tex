...
For any given externality $e$, to induce the threshold $\tau(e)$ the participant 
penalty $r(e)$ must be equal to the expected utility from allocation for a bidder 
with type at the threshold ($e,\tau(e)$). Thus, the penalty function may be calculated 
as in \eqref{eq:r_pa}.
\begin{equation}
    R^{\text{PA}}(e) = \bigl[A(e)\,\tau(e;\,\bsc^*)\bigr] - P(e).
    \label{eq:r_pa}
\end{equation}
